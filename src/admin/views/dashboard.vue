<template>
  <section class="container-fluid">
    <!-- Page Title-->
    <h2 class="fs-3 fw-bold mb-2">Welcome back, Antony O. 👋</h2>
    <p class="text-muted mb-5">
      Get a quick overview of your company's current status below, or click into
      one of the sections for a more detailed breakdown.
    </p>
    <!-- / Page Title-->
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-sm-6 col-xxl-3">
        <div class="card h-100">
          <div
            class="card-header justify-content-between align-items-center d-flex border-0 pb-0"
          >
            <h6
              class="card-title m-0 text-muted fs-xs text-uppercase fw-bolder tracking-wide"
            >
              Monthly Income
            </h6>
          </div>
            ...
            <div class="row gx-4 mb-3 mb-md-1">
              <div class="col-12 col-md-6">
                <p class="fs-3 fw-bold d-flex align-items-center">
                  <span class="fs-9 me-1">$</span> 567,99
                </p>
              </div>
              <div class="col-12 col-md-6">
                <div class="chart chart-sm">
                  ...
                  <canvas
                    id="chartMonthlyIncome"
                    style="display: block; width: 206px; height: 36px"
                    width="206"
                    height="36"
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row gx-4 mb-3 mb-md-1">
              <div class="col-12 col-md-6">
                <p class="fs-3 fw-bold d-flex align-items-center">
                  <span class="fs-9 me-1">$</span> 193,99
                </p>
              </div>
              <div class="col-12 col-md-6">
                <div class="chart chart-sm">
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row gx-4 mb-3 mb-md-1">
              <div class="col-12 col-md-6">
                <p class="fs-3 fw-bold d-flex align-items-center">
                  <span class="fs-9 me-1">$</span> 12,340
                </p>
              </div>
              <div class="col-12 col-md-6">
                <div class="chart chart-sm">
        ...
        <div class="card h-100 bg-primary border-primary">
          ...
          >
            <div class="d-flex align-items-center flex-shrink-0">
              ...
              <h6
                class="card-title m-0 text-light fs-xs text-uppercase fw-bolder tracking-wide"
              >
                Upcoming Events
              </h6>
            </div>
            <div
              class="swiper-announcement-pagination text-end text-white opacity-75 fw-bold fs-9 swiper-pagination-fraction"
            >
          ...
          <div class="card-body mt-3">
            <div class="d-flex flex-grow-1 overflow-hidden text-white">
              <!-- Swiper Latest -->
              <div
                class="swiper-container overflow-hidden w-auto swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                data-swiper=""
                data-options='{
                    "spaceBetween": 10,
                    "loop": true,
              ...
              >
                <div
                  ...
                  style="
                    transform: translate3d(-1784px, 0px, 0px);
                    transition-duration: 0ms;
                  "
                >
                  <div
                    class="swiper-slide text-white swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev"
                  ...
                  >
                    ...
                    <div class="d-flex mb-4 align-items-start">
                      <div
                        class="me-3 text-center pe-3 border-end-white-opacity"
                      >
                        <span
                          class="d-block text-uppercase small fw-bolder tracking-wide lh-1"
                          >Mon</span
                        >
                        <span
                          class="d-block fs-3 text-uppercase fw-bold tracking-wide lh-1 mt-1"
                          >28</span
                        >
                      </div>
                      <div>
                        <p class="mb-0 fs-5 fw-bolder lh-1">
                          Summer Staff Party
                        </p>
                        <small class="d-block lh-1 opacity-75 mt-2"
                          >Yearly company summer party</small
                        >
                      </div>
                    </div>
                    <!-- / Event Date & Title-->
                    ...
                    <div class="d-flex align-items-start mb-5">
                      <button class="btn-icon bg-white opacity-25 me-3">
                        <i class="ri-map-pin-line"></i>
                      </button>
                      <div>
                        <span class="d-block fw-bolder fs-6"
                          >8 Northumberland Avenue</span
                        >
                        <small class="d-block opacity-75"
                          >London, SW12 3RT</small
                        >
                      </div>
                    </div>
                    <!-- / Event Location-->
                    ...
                    >
                      <div class="avatar-group me-4">
                        <picture class="avatar-group-img">
                          <img
                            class="f-w-10 rounded-circle border-primary"
                            src="/src/admin/assets/images/profile-small.jpeg"
                            alt=""
                          />
                        </picture>
                        <picture class="avatar-group-img">
                          <img
                            class="f-w-10 rounded-circle border-primary"
                            src="/src/admin/assets/images/profile-small-2.jpeg"
                            alt=""
                          />
                        </picture>
                        <picture class="avatar-group-img">
                          <img
                            class="f-w-10 rounded-circle border-primary"
                            src="/src/admin/assets/images/profile-small-3.jpeg"
                            alt=""
                          />
                        </picture>
                        <picture class="avatar-group-img">
                          <img
                            class="f-w-10 rounded-circle border-primary"
                            src="/src/admin/assets/images/profile-small-4.jpeg"
                            alt=""
                          />
                        </picture>
                        <span class="small fw-bolder ms-2 text-white opacity-90"
                          >+ 32 more</span
                        >
                      </div>
                      ...
                      <div class="mt-3 mt-lg-0">
                        ...
                        <button
                          class="btn btn-sm btn-link text-white fw-bolder opacity-75"
                        >
                          Cancel
                        </button>
                      </div>
                  ...
                  <div
                    class="swiper-slide text-white swiper-slide-duplicate-active"
                  ...
                  >
                    ...
                    <div class="d-flex mb-4 align-items-start">
                      ...
                      <div>
                        ...
                        <small class="d-block lh-1 opacity-75 mt-2"
                          >Review sales staff with Mike, John, Sally</small
                        >
                      </div>
                    </div>
                    <!-- / Event Date & Title-->
                  ...
                  >
                    ...
                    <div class="d-flex mb-4 align-items-start">
                      ...
                      <div>
                        ...
                        <small class="d-block lh-1 opacity-75 mt-2"
                          >Budget meeting with Patrick and Debbie</small
                        >
                      </div>
                    </div>
                    <!-- / Event Date & Title-->
                    ...
                    <div class="d-flex align-items-start mb-5">
                      ...
                      <div>
                        <span class="d-block fw-bolder fs-6"
                          >South Bank Events Hall</span
                        >
                        <small class="d-block opacity-75"
                          >London, SE4 7EH</small
                        >
                      </div>
                    </div>
                    <!-- / Event Location-->
                  ...
                  <div
                    class="swiper-slide text-white swiper-slide-prev swiper-slide-duplicate-next"
                    data-swiper-slide-index="2"
                    style="width: 436px; margin-right: 10px"
                  >
                    <!-- Event Date & Title-->
                  ...
                  <div
                    class="swiper-slide text-white swiper-slide-duplicate swiper-slide-active"
                    data-swiper-slide-index="0"
                    style="width: 436px; margin-right: 10px"
                  >
                    <!-- Event Date & Title-->
            ...
            <div class="row gx-2 h-100">
              <div class="col-3 d-none d-xl-flex h-100 align-items-center">
                <picture>
                  <img
                    class="w-100"
                    src="/src/admin/assets/images/refer.svg"
              ...
              >
                <p class="fw-bold fs-5">
                  Refer a friend and get one month's pro subscription free
                </p>
                <p class="text-muted">
                  We'll give you a month's pro subscription for every friend
                  that signs up to Apollo.
                </p>
                <a href="#" class="btn btn-outline-secondary btn-sm text-body"
                  ><i class="ri-file-copy-line align-middle"></i> Copy invite
                  code</a
                >
              </div>
              <div class="col-3 d-none d-xl-flex h-100 align-items-center">
                <picture>
                  <img
                    class="w-100"
                    src="/src/admin/assets/images/refer-2.svg"
                    alt="HTML Bootstrap Admin Template by Pixel Rocket"
                  />
                </picture>
              </div>
    ...
    <div class="row g-4 mb-4 mt-0">
      ...
      <div class="col-12 col-xxl-4">
        <div class="card mb-4 h-100">
          ...
          >
            ...
            <div class="dropdown">
              ...
              <ul
                ...
                aria-labelledby="dropdownExpenses"
              >
          ...
          <div class="card-body">
            <div
              class="d-flex justify-content-between align-items-start mb-4 mt-2"
            >
              <div class="d-flex align-items-center">
                <h4 class="fs-3 fw-bold mb-0 me-3">$123,668</h4>
                <span
                  class="badge bg-success-faded text-success d-flex align-items-center"
                >
              ...
              <div class="d-flex align-items-center ms-2 d-xxl-none">
                <div class="d-flex align-items-center">
                  <span
                    class="f-w-2 f-h-2 bg-primary d-block rounded-circle me-2"
                  ></span>
                  <span class="small text-muted">2021</span>
                </div>
                <div class="d-flex align-items-center ms-4">
                  <span
                    class="f-w-2 f-h-2 bg-secondary-faded d-block rounded-circle me-2"
                  ></span>
            ...
            <div class="chart chart-md pt-2">
              ...
              <canvas
                id="chartBar"
                style="display: block; width: 946px; height: 152px"
                width="946"
                height="152"
                class="chartjs-render-monitor"
              ></canvas>
            ...
            <ul class="list-unstyled m-0">
              <li class="d-flex justify-content-between py-2">
                ...
                <div class="d-flex align-items-center justify-content-end">
                  <span
                    class="text-muted text-end small me-1 d-lg-none d-xxl-block"
                    >31.2%</span
                  >
                  <span
                    class="badge bg-transparent text-success d-flex align-items-center"
                  >
              ...
              <li class="d-flex justify-content-between py-2">
                ...
                <div class="d-flex align-items-center justify-content-end">
                  ...
                  >
                  <span
                    class="badge bg-transparent text-danger d-flex align-items-center"
                  >
                    <span class="f-w-4 d-block">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="card-body">
            <ul class="list-unstyled m-0">
              <li class="d-flex justify-content-between py-2">
                <div class="d-flex align-items-center">
                  <span class="f-w-4 me-3 lh-1">
                    <picture>
                      <img
                        class="img-fluid"
                        src="/src/admin/assets/images/logos/logo-17.svg"
                        alt=""
                      />
                    </picture>
                  </span>
                ...
                <div class="d-flex align-items-center justify-content-end">
                  <span class="text-muted text-end small d-lg-none d-xxl-block"
                    >144,678</span
                  >
                ...
                <div class="d-flex align-items-center">
                  <span class="f-w-4 me-3 lh-1">
                    <picture>
                      <img
                        class="img-fluid"
                        src="/src/admin/assets/images/logos/logo-18.svg"
                        alt=""
                      />
                    </picture>
                  </span>
                ...
                <div class="d-flex align-items-center">
                  <span class="f-w-4 me-3 lh-1">
                    <picture>
                      <img
                        class="img-fluid"
                        src="/src/admin/assets/images/logos/logo-19.svg"
                        alt=""
                      />
                    </picture>
                  </span>
        ...
        <div class="card mb-4 h-100">
          ...
          <div class="card-body">
            <div class="chart chart-lg">
              ...
              <canvas
                id="chartDoughnut"
                style="display: block; width: 266px; height: 320px"
                width="266"
                height="320"
                class="chartjs-render-monitor"
              ></canvas>
            ...
            <div class="row g-1 mt-4">
              <div
                class="col-12 col-sm-4 d-flex flex-column align-items-center"
              >
              ...
              >
                ...
                <div class="d-flex align-items-center">
                  <span
                    class="f-w-2 f-h-2 bg-warning d-block rounded-circle me-2"
                  ></span>
            ...
            <a href="#" class="btn btn-light d-table mx-auto mt-4"
              >View full expenses</a
            >
          </div>
        </div>
      </div>
        ...
        <div class="card mb-4 h-100">
          ...
          >
            ...
            <div class="dropdown">
              ...
              <ul
                class="dropdown-menu dropdown"
                aria-labelledby="dropdownYearly"
              >
                <li><a class="dropdown-item" href="#">Action</a></li>
                <li><a class="dropdown-item" href="#">Another action</a></li>
                <li>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-5">
              ...
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                  <span
                    class="f-w-4 rounded f-h-1 bg-primary d-block me-2"
                  ></span>
                  <span class="small text-muted">2021</span>
                </div>
                <div class="d-flex align-items-center ms-4">
                  <span
                    class="f-w-4 rounded f-h-1 bg-secondary-faded d-block me-2"
                  ></span>
                  <span class="small text-muted">2020</span>
                </div>
              </div>
            ...
            <div class="chart">
              <div class="chart chart-lg">
                ...
                <canvas
                  id="chartLine"
                  style="display: block; width: 606px; height: 320px"
                  width="606"
                  height="320"
                  class="chartjs-render-monitor"
                ></canvas>
      ...
      <div class="col-12">
        <div class="card mb-4 h-100">
          ...
          >
            ...
            <a href="#" class="btn btn-outline-secondary btn-sm text-body"
              ><i class="ri-download-2-line align-middle"></i> Export</a
            >
          </div>
          <div class="card-body">
              ...
              <table class="table m-0 table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span
                        class="badge rounded-pill bg-success-faded text-success"
                        >completed</span
                      >
                    </td>
                    <td>
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu dropdown"
                          aria-labelledby="dropdownOrder-0"
                        >
                          <li><a class="dropdown-item" href="#">Action</a></li>
                          <li>
                  ...
                  <tr>
                    ...
                    <th class="text-muted">$123.99</th>
                    <td>
                      <span class="badge rounded-pill bg-info-faded text-info"
                        >processing</span
                      >
                    </td>
                    <td>
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu dropdown"
                          aria-labelledby="dropdownOrder-1"
                        >
                          <li><a class="dropdown-item" href="#">Action</a></li>
                          <li>
                            <a class="dropdown-item" href="#">Another action</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <span
                        class="badge rounded-pill bg-danger-faded text-danger"
                        >cancelled</span
                      >
                    </td>
                    <td>
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu dropdown"
                          aria-labelledby="dropdownOrder-2"
                        >
                          <li><a class="dropdown-item" href="#">Action</a></li>
                          <li>
                            <a class="dropdown-item" href="#">Another action</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu dropdown"
                          aria-labelledby="dropdownOrder-3"
                        >
                          <li><a class="dropdown-item" href="#">Action</a></li>
                          <li>
                            <a class="dropdown-item" href="#">Another action</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu dropdown"
                          aria-labelledby="dropdownOrder-4"
                        >
                          <li><a class="dropdown-item" href="#">Action</a></li>
                          <li>
                            <a class="dropdown-item" href="#">Another action</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu dropdown"
                          aria-labelledby="dropdownOrder-5"
                        >
                          <li><a class="dropdown-item" href="#">Action</a></li>
                          <li>
                            <a class="dropdown-item" href="#">Another action</a>
              ...
              <tbody>
                <tr>
                  <td class="ps-0">
                    <picture>
                      <img
                        class="f-w-12 rounded"
                        src="/src/admin/assets/images/logos/logo-13.svg"
                        alt="HTML Bootstrap Admin Template by Pixel Rocket"
                      />
                    </picture>
                  </td>
                ...
                <tr>
                  <td class="ps-0">
                    <picture>
                      <img
                        class="f-w-12 rounded"
                        src="/src/admin/assets/images/logos/logo-15.svg"
                        alt="HTML Bootstrap Admin Template by Pixel Rocket"
                      />
                    </picture>
                  </td>
                ...
                <tr>
                  <td class="ps-0">
                    <picture>
                      <img
                        class="f-w-12 rounded"
                        src="/src/admin/assets/images/logos/logo-14.svg"
                        alt="HTML Bootstrap Admin Template by Pixel Rocket"
                      />
                    </picture>
                  </td>
        ...
        <div class="card mb-4 h-100">
          ...
          >
            ...
            <div class="dropdown">
              ...
              <ul
                class="dropdown-menu dropdown"
                aria-labelledby="dropdownNewsletter"
              >
                <li><a class="dropdown-item" href="#">Action</a></li>
                <li><a class="dropdown-item" href="#">Another action</a></li>
                <li>
          ...
          <div class="card-body">
            ...
            <div class="progress f-h-1">
              <div
                ...
                title=""
                data-bs-original-title="Gross sales"
              ...
              <div
                ...
                data-bs-placement="top"
                title=""
                data-bs-original-title="Net sales"
              ...
              <div
                ...
                data-bs-placement="top"
                title=""
                data-bs-original-title="Total profit"
                aria-label="Total profit"
              ></div>
            </div>
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <span
                        class="f-w-2 f-h-2 rounded-circle bg-primary d-block"
                      ></span>
                  ...
                  <td>
                    <span class="fw-bolder"
                      >$3,289.99 <span class="text-muted">(54.3%)</span></span
                    >
                  </td>
                  <td class="text-end">
                    <span
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <span
                        class="f-w-2 f-h-2 rounded-circle bg-primary d-block opacity-75"
                      ></span>
                  ...
                  <td>
                    <span class="fw-bolder"
                      >$1,758.99 <span class="text-muted">(32.3%)</span></span
                    >
                  </td>
                  <td class="text-end">
                    <span
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <span
                        class="f-w-2 f-h-2 rounded-circle bg-primary d-block opacity-50"
                      ></span>
                  ...
                  <td>
                    <span class="fw-bolder"
                      >$699.54 <span class="text-muted">(12.3%)</span></span
                    >
                  </td>
                  <td class="text-end">
                    <span
    ...
    <footer class="footer">
      ...
      <p class="small text-muted m-0">
        Template created by
        <a href="https://www.pixelrocket.store/">PixelRocket</a>
      </p>
    </footer>
    ...
    >
      ...
      <div class="offcanvas-body">
        <ul class="list-group list-group-flush">
          <li
            class="list-group-item pt-0 pb-5 list-group-activity d-flex align-items-start"
          >
            <div class="avatar avatar-xs me-3 flex-shrink-0">
              <picture>
                <img
                  class="f-w-10 rounded-circle"
                  src="/src/admin/assets/images/profile-small-7.jpeg"
                  alt=""
                />
              </picture>
            ...
            <div class="d-flex flex-column flex-grow-1">
              ...
              <span class="small d-block text-muted"
                >Submitted quarterly marketing report for review.</span
              >
              <div
          ...
          >
            ...
            <div class="d-flex flex-column flex-grow-1">
              ...
              <span class="small d-block text-muted"
                >Marked project status as completed.</span
              >
            </div>
          </li>
          <li
          ...
          >
            ...
            <div class="d-flex flex-column flex-grow-1">
              ...
              <span class="small d-block text-muted"
                >Created 2 new products in Mens Shoes</span
              >
              <div
                class="bg-light border rounded-md p-2 mt-2 d-flex justify-content-start align-items-start"
              >
                <picture class="me-2">
                  <img
                    class="f-w-12 rounded"
                    src="/src/admin/assets/images/1.png"
                    alt=""
                  />
                </picture>
                <picture>
                  <img
                    class="f-w-12 rounded"
                    src="/src/admin/assets/images/3.png"
                    alt=""
                  />
                </picture>
              </div>
          ...
          >
            ...
            <div class="d-flex flex-column flex-grow-1">
              ...
              <span class="small d-block text-muted"
                >Set user status as 'offline'</span
              >
            </div>
          </li>
        </ul>
    ...
    >
      <div class="offcanvas-header position-relative">
        <div class="d-flex flex-column w-100">
          <h5 class="offcanvas-title mb-3" id="offcanvasMessageLabel">
            Company Meetup
          </h5>
          <div class="d-flex justify-content-between align-items-center">
            <div class="avatar-group me-4">
              ...
              <span class="small fw-bolder ms-2 text-muted opacity-90"
                >+ 12 others</span
              >
            </div>
            <div class="dropdown">
              <button
                class="btn btn-link dropdown-toggle dropdown-toggle-icon p-0"
                type="button"
                id="dropdownTop"
                data-bs-toggle="dropdown"
                aria-expanded="false"
        ...
        <button
          type="button"
          class="btn-close text-reset position-absolute top-20 end-5"
          data-bs-dismiss="offcanvas"
          aria-label="Close"
        ></button>
      </div>
      <div
        class="offcanvas-body h-100 d-flex justify-content-between flex-column pb-0"
      >
        <div class="overflow-auto py-4">
          <div class="overflow-hidden">
            <!-- Messages-->
            <div
              class="d-flex align-items-end justify-content-start mb-4 flex-wrap"
            >
              <div class="avatar avatar-xs me-3 flex-shrink-0">
                <picture>
                  <img
              ...
              <div
                class="d-flex justify-content-start flex-column align-items-start col"
              >
                <small class="text-muted fs-xs fw-bolder"
                  ><span class="fw-bold">Patrick Johnson</span> · 2 mins
                  ago</small
                >
                <div
                  class="bg-light p-3 mt-2 rounded-t-s-4 rounded-t-e-4 rounded-b-e-4"
                >
            ...
            >
              <div
                class="d-flex justify-content-end flex-column align-items-end col"
              >
                <small class="text-muted fs-xs fw-bolder"
                  ><span class="fw-bold">You</span> · 5 mins ago</small
                >
                <div
            ...
            >
              ...
              >
                <small class="text-muted fs-xs fw-bolder"
                  ><span class="fw-bold">Patrick Johnson</span> · 25 mins
                  ago</small
                >
                <div
                  class="bg-light p-3 mt-2 rounded-t-s-4 rounded-t-e-4 rounded-b-e-4"
        ...
        <div class="border-top p-4 mx-n3">
          <div class="d-flex flex-column align-items-end">
            <input
              type="text"
              class="form-control d-flex w-100 bg-light border-0 text-muted mb-3"
...
<script setup>
import background from 'assets/image/library.jpg';
</script>
