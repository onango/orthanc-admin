      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="modalLabel" class="modal-title">
            {{ $t('share.modal_title') + ' ' + resourceTitle }}
          </h5>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-body">
          <div class="container">
            <div class="row py-3">
              ...
              <div class="col-md-5">
                <select v-model="expirationInDays" class="form-select">
                  <option
                    v-for="duration in uiOptions.ShareDurations"
                    :key="duration"
                    :value="duration"
                  >
                    {{ getDurationText(duration) }}
            ...
            <div class="row py-3">
              ...
              <div class="col-md-1">
                <div class="d-flex flex-row-reverse">
                  <CopyToClipboardButton :value-to-copy="shareLink" />
                </div>
              </div>
            </div>
          </div>
